...
import (
	"github.com/miyamo2/api.miyamo.today/article-service/internal/app/usecase/query"
	impl "github.com/miyamo2/api.miyamo.today/article-service/internal/infra/rdb/query"
	"go.uber.org/fx"
)
