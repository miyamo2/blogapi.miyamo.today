...
import (
	grpc "blogapi.miyamo.today/blogging-event-service/internal/infra/grpc"
...
type BloggingEventServiceClient interface {
	CreateArticle(context.Context, *connect.Request[grpc.CreateArticleRequest]) (*connect.Response[grpc.BloggingEventResponse], error)
	UpdateArticleTitle(context.Context, *connect.Request[grpc.UpdateArticleTitleRequest]) (*connect.Response[grpc.BloggingEventResponse], error)
	UpdateArticleBody(context.Context, *connect.Request[grpc.UpdateArticleBodyRequest]) (*connect.Response[grpc.BloggingEventResponse], error)
	UpdateArticleThumbnail(context.Context, *connect.Request[grpc.UpdateArticleThumbnailRequest]) (*connect.Response[grpc.BloggingEventResponse], error)
	AttachTags(context.Context, *connect.Request[grpc.AttachTagsRequest]) (*connect.Response[grpc.BloggingEventResponse], error)
	DetachTags(context.Context, *connect.Request[grpc.DetachTagsRequest]) (*connect.Response[grpc.BloggingEventResponse], error)
	UploadImage(context.Context) *connect.ClientStreamForClient[grpc.UploadImageRequest, grpc.UploadImageResponse]
}
...
func NewBloggingEventServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) BloggingEventServiceClient {
	...
	bloggingEventServiceMethods := grpc.File_blogging_event_blogging_event_proto.Services().ByName("BloggingEventService").Methods()
	return &bloggingEventServiceClient{
		createArticle: connect.NewClient[grpc.CreateArticleRequest, grpc.BloggingEventResponse](
			httpClient,
		...
		updateArticleTitle: connect.NewClient[grpc.UpdateArticleTitleRequest, grpc.BloggingEventResponse](
			httpClient,
		...
		updateArticleBody: connect.NewClient[grpc.UpdateArticleBodyRequest, grpc.BloggingEventResponse](
			httpClient,
		...
		updateArticleThumbnail: connect.NewClient[grpc.UpdateArticleThumbnailRequest, grpc.BloggingEventResponse](
			httpClient,
		...
		attachTags: connect.NewClient[grpc.AttachTagsRequest, grpc.BloggingEventResponse](
			httpClient,
			baseURL+BloggingEventServiceAttachTagsProcedure,
			connect.WithSchema(bloggingEventServiceMethods.ByName("AttachTags")),
			connect.WithClientOptions(opts...),
		),
		detachTags: connect.NewClient[grpc.DetachTagsRequest, grpc.BloggingEventResponse](
			httpClient,
			baseURL+BloggingEventServiceDetachTagsProcedure,
			connect.WithSchema(bloggingEventServiceMethods.ByName("DetachTags")),
			connect.WithClientOptions(opts...),
		),
		uploadImage: connect.NewClient[grpc.UploadImageRequest, grpc.UploadImageResponse](
			httpClient,
...
type bloggingEventServiceClient struct {
	createArticle          *connect.Client[grpc.CreateArticleRequest, grpc.BloggingEventResponse]
	updateArticleTitle     *connect.Client[grpc.UpdateArticleTitleRequest, grpc.BloggingEventResponse]
	updateArticleBody      *connect.Client[grpc.UpdateArticleBodyRequest, grpc.BloggingEventResponse]
	updateArticleThumbnail *connect.Client[grpc.UpdateArticleThumbnailRequest, grpc.BloggingEventResponse]
	attachTags             *connect.Client[grpc.AttachTagsRequest, grpc.BloggingEventResponse]
	detachTags             *connect.Client[grpc.DetachTagsRequest, grpc.BloggingEventResponse]
	uploadImage            *connect.Client[grpc.UploadImageRequest, grpc.UploadImageResponse]
}

// CreateArticle calls blogging_event.BloggingEventService.CreateArticle.
func (c *bloggingEventServiceClient) CreateArticle(ctx context.Context, req *connect.Request[grpc.CreateArticleRequest]) (*connect.Response[grpc.BloggingEventResponse], error) {
	return c.createArticle.CallUnary(ctx, req)
}

// UpdateArticleTitle calls blogging_event.BloggingEventService.UpdateArticleTitle.
func (c *bloggingEventServiceClient) UpdateArticleTitle(ctx context.Context, req *connect.Request[grpc.UpdateArticleTitleRequest]) (*connect.Response[grpc.BloggingEventResponse], error) {
...
func (c *bloggingEventServiceClient) UpdateArticleBody(ctx context.Context, req *connect.Request[grpc.UpdateArticleBodyRequest]) (*connect.Response[grpc.BloggingEventResponse], error) {
...
func (c *bloggingEventServiceClient) UpdateArticleThumbnail(ctx context.Context, req *connect.Request[grpc.UpdateArticleThumbnailRequest]) (*connect.Response[grpc.BloggingEventResponse], error) {
	return c.updateArticleThumbnail.CallUnary(ctx, req)
}

// AttachTags calls blogging_event.BloggingEventService.AttachTags.
func (c *bloggingEventServiceClient) AttachTags(ctx context.Context, req *connect.Request[grpc.AttachTagsRequest]) (*connect.Response[grpc.BloggingEventResponse], error) {
	return c.attachTags.CallUnary(ctx, req)
}

// DetachTags calls blogging_event.BloggingEventService.DetachTags.
func (c *bloggingEventServiceClient) DetachTags(ctx context.Context, req *connect.Request[grpc.DetachTagsRequest]) (*connect.Response[grpc.BloggingEventResponse], error) {
	return c.detachTags.CallUnary(ctx, req)
}

// UploadImage calls blogging_event.BloggingEventService.UploadImage.
func (c *bloggingEventServiceClient) UploadImage(ctx context.Context) *connect.ClientStreamForClient[grpc.UploadImageRequest, grpc.UploadImageResponse] {
...
type BloggingEventServiceHandler interface {
	...
	AttachTags(context.Context, *connect.Request[grpc.AttachTagsRequest]) (*connect.Response[grpc.BloggingEventResponse], error)
	DetachTags(context.Context, *connect.Request[grpc.DetachTagsRequest]) (*connect.Response[grpc.BloggingEventResponse], error)
	UploadImage(context.Context, *connect.ClientStream[grpc.UploadImageRequest]) (*connect.Response[grpc.UploadImageResponse], error)
}
...
func (UnimplementedBloggingEventServiceHandler) CreateArticle(context.Context, *connect.Request[grpc.CreateArticleRequest]) (*connect.Response[grpc.BloggingEventResponse], error) {
...
func (UnimplementedBloggingEventServiceHandler) UpdateArticleTitle(context.Context, *connect.Request[grpc.UpdateArticleTitleRequest]) (*connect.Response[grpc.BloggingEventResponse], error) {
...
func (UnimplementedBloggingEventServiceHandler) UpdateArticleBody(context.Context, *connect.Request[grpc.UpdateArticleBodyRequest]) (*connect.Response[grpc.BloggingEventResponse], error) {
...
func (UnimplementedBloggingEventServiceHandler) UpdateArticleThumbnail(context.Context, *connect.Request[grpc.UpdateArticleThumbnailRequest]) (*connect.Response[grpc.BloggingEventResponse], error) {
...
func (UnimplementedBloggingEventServiceHandler) AttachTags(context.Context, *connect.Request[grpc.AttachTagsRequest]) (*connect.Response[grpc.BloggingEventResponse], error) {
...
func (UnimplementedBloggingEventServiceHandler) DetachTags(context.Context, *connect.Request[grpc.DetachTagsRequest]) (*connect.Response[grpc.BloggingEventResponse], error) {
...
func (UnimplementedBloggingEventServiceHandler) UploadImage(context.Context, *connect.ClientStream[grpc.UploadImageRequest]) (*connect.Response[grpc.UploadImageResponse], error) {
