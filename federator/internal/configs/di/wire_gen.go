...
func GetDependencies() *Dependencies {
	...
	usecases := provider.Usecases(article, articles, tag, tags, createArticle, updateArticleTitle, updateArticleBody, updateArticleThumbnail, attachTags, detachTags)
	converter := converters.NewConverter()
	resolverConverters := provider.Converters(converter, converter, converter, converter, converter, converter, converter, converter, converter)
