...
type ArticleServiceClient interface {
	GetArticleById(context.Context, *connect.Request[article.GetArticleByIdRequest]) (*connect.Response[article.GetArticleByIdResponse], error)
	GetAllArticles(context.Context, *connect.Request[emptypb.Empty]) (*connect.Response[article.GetAllArticlesResponse], error)
	GetNextArticles(context.Context, *connect.Request[article.GetNextArticlesRequest]) (*connect.Response[article.GetNextArticlesResponse], error)
	GetPrevArticles(context.Context, *connect.Request[article.GetPrevArticlesRequest]) (*connect.Response[article.GetPrevArticlesResponse], error)
}
...
func NewArticleServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ArticleServiceClient {
	...
	articleServiceMethods := article.File_article_article_proto.Services().ByName("ArticleService").Methods()
	return &articleServiceClient{
		getArticleById: connect.NewClient[article.GetArticleByIdRequest, article.GetArticleByIdResponse](
			httpClient,
			baseURL+ArticleServiceGetArticleByIdProcedure,
			connect.WithSchema(articleServiceMethods.ByName("GetArticleById")),
			connect.WithClientOptions(opts...),
		),
		getAllArticles: connect.NewClient[emptypb.Empty, article.GetAllArticlesResponse](
			httpClient,
			baseURL+ArticleServiceGetAllArticlesProcedure,
			connect.WithSchema(articleServiceMethods.ByName("GetAllArticles")),
			connect.WithClientOptions(opts...),
		),
		getNextArticles: connect.NewClient[article.GetNextArticlesRequest, article.GetNextArticlesResponse](
			httpClient,
			baseURL+ArticleServiceGetNextArticlesProcedure,
			connect.WithSchema(articleServiceMethods.ByName("GetNextArticles")),
			connect.WithClientOptions(opts...),
		),
		getPrevArticles: connect.NewClient[article.GetPrevArticlesRequest, article.GetPrevArticlesResponse](
			httpClient,
...
type articleServiceClient struct {
	getArticleById  *connect.Client[article.GetArticleByIdRequest, article.GetArticleByIdResponse]
	getAllArticles  *connect.Client[emptypb.Empty, article.GetAllArticlesResponse]
	getNextArticles *connect.Client[article.GetNextArticlesRequest, article.GetNextArticlesResponse]
	getPrevArticles *connect.Client[article.GetPrevArticlesRequest, article.GetPrevArticlesResponse]
}

// GetArticleById calls article.ArticleService.GetArticleById.
func (c *articleServiceClient) GetArticleById(ctx context.Context, req *connect.Request[article.GetArticleByIdRequest]) (*connect.Response[article.GetArticleByIdResponse], error) {
	return c.getArticleById.CallUnary(ctx, req)
}

// GetAllArticles calls article.ArticleService.GetAllArticles.
func (c *articleServiceClient) GetAllArticles(ctx context.Context, req *connect.Request[emptypb.Empty]) (*connect.Response[article.GetAllArticlesResponse], error) {
	return c.getAllArticles.CallUnary(ctx, req)
}

// GetNextArticles calls article.ArticleService.GetNextArticles.
func (c *articleServiceClient) GetNextArticles(ctx context.Context, req *connect.Request[article.GetNextArticlesRequest]) (*connect.Response[article.GetNextArticlesResponse], error) {
	return c.getNextArticles.CallUnary(ctx, req)
}

// GetPrevArticles calls article.ArticleService.GetPrevArticles.
func (c *articleServiceClient) GetPrevArticles(ctx context.Context, req *connect.Request[article.GetPrevArticlesRequest]) (*connect.Response[article.GetPrevArticlesResponse], error) {
...
func (UnimplementedArticleServiceHandler) GetArticleById(context.Context, *connect.Request[article.GetArticleByIdRequest]) (*connect.Response[article.GetArticleByIdResponse], error) {
...
func (UnimplementedArticleServiceHandler) GetAllArticles(context.Context, *connect.Request[emptypb.Empty]) (*connect.Response[article.GetAllArticlesResponse], error) {
...
func (UnimplementedArticleServiceHandler) GetNextArticles(context.Context, *connect.Request[article.GetNextArticlesRequest]) (*connect.Response[article.GetNextArticlesResponse], error) {
...
func (UnimplementedArticleServiceHandler) GetPrevArticles(context.Context, *connect.Request[article.GetPrevArticlesRequest]) (*connect.Response[article.GetPrevArticlesResponse], error) {
