...
type TagServiceClient interface {
	GetTagById(context.Context, *connect.Request[tag.GetTagByIdRequest]) (*connect.Response[tag.GetTagByIdResponse], error)
	GetAllTags(context.Context, *connect.Request[emptypb.Empty]) (*connect.Response[tag.GetAllTagsResponse], error)
	GetNextTags(context.Context, *connect.Request[tag.GetNextTagsRequest]) (*connect.Response[tag.GetNextTagResponse], error)
	GetPrevTags(context.Context, *connect.Request[tag.GetPrevTagsRequest]) (*connect.Response[tag.GetPrevTagResponse], error)
}
...
func NewTagServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) TagServiceClient {
	...
	tagServiceMethods := tag.File_tag_tag_proto.Services().ByName("TagService").Methods()
	return &tagServiceClient{
		getTagById: connect.NewClient[tag.GetTagByIdRequest, tag.GetTagByIdResponse](
			httpClient,
			baseURL+TagServiceGetTagByIdProcedure,
			connect.WithSchema(tagServiceMethods.ByName("GetTagById")),
			connect.WithClientOptions(opts...),
		),
		getAllTags: connect.NewClient[emptypb.Empty, tag.GetAllTagsResponse](
			httpClient,
			baseURL+TagServiceGetAllTagsProcedure,
			connect.WithSchema(tagServiceMethods.ByName("GetAllTags")),
			connect.WithClientOptions(opts...),
		),
		getNextTags: connect.NewClient[tag.GetNextTagsRequest, tag.GetNextTagResponse](
			httpClient,
			baseURL+TagServiceGetNextTagsProcedure,
			connect.WithSchema(tagServiceMethods.ByName("GetNextTags")),
			connect.WithClientOptions(opts...),
		),
		getPrevTags: connect.NewClient[tag.GetPrevTagsRequest, tag.GetPrevTagResponse](
			httpClient,
...
type tagServiceClient struct {
	getTagById  *connect.Client[tag.GetTagByIdRequest, tag.GetTagByIdResponse]
	getAllTags  *connect.Client[emptypb.Empty, tag.GetAllTagsResponse]
	getNextTags *connect.Client[tag.GetNextTagsRequest, tag.GetNextTagResponse]
	getPrevTags *connect.Client[tag.GetPrevTagsRequest, tag.GetPrevTagResponse]
}

// GetTagById calls tag.TagService.GetTagById.
func (c *tagServiceClient) GetTagById(ctx context.Context, req *connect.Request[tag.GetTagByIdRequest]) (*connect.Response[tag.GetTagByIdResponse], error) {
	return c.getTagById.CallUnary(ctx, req)
}

// GetAllTags calls tag.TagService.GetAllTags.
func (c *tagServiceClient) GetAllTags(ctx context.Context, req *connect.Request[emptypb.Empty]) (*connect.Response[tag.GetAllTagsResponse], error) {
	return c.getAllTags.CallUnary(ctx, req)
}

// GetNextTags calls tag.TagService.GetNextTags.
func (c *tagServiceClient) GetNextTags(ctx context.Context, req *connect.Request[tag.GetNextTagsRequest]) (*connect.Response[tag.GetNextTagResponse], error) {
	return c.getNextTags.CallUnary(ctx, req)
}

// GetPrevTags calls tag.TagService.GetPrevTags.
func (c *tagServiceClient) GetPrevTags(ctx context.Context, req *connect.Request[tag.GetPrevTagsRequest]) (*connect.Response[tag.GetPrevTagResponse], error) {
...
func (UnimplementedTagServiceHandler) GetTagById(context.Context, *connect.Request[tag.GetTagByIdRequest]) (*connect.Response[tag.GetTagByIdResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("tag.TagService.GetTagById is not implemented"))
}

func (UnimplementedTagServiceHandler) GetAllTags(context.Context, *connect.Request[emptypb.Empty]) (*connect.Response[tag.GetAllTagsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("tag.TagService.GetAllTags is not implemented"))
}

func (UnimplementedTagServiceHandler) GetNextTags(context.Context, *connect.Request[tag.GetNextTagsRequest]) (*connect.Response[tag.GetNextTagResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("tag.TagService.GetNextTags is not implemented"))
}

func (UnimplementedTagServiceHandler) GetPrevTags(context.Context, *connect.Request[tag.GetPrevTagsRequest]) (*connect.Response[tag.GetPrevTagResponse], error) {
