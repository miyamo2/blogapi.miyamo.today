...
// Source: blogapi.miyamo.today/core/db (interfaces: TransactionManager,Transaction,Statement)
//
// Generated by this command:
//
//	mockgen.exe blogapi.miyamo.today/core/db TransactionManager,Transaction,Statement
//
