...
var (
	tagServiceServiceDescriptor           = grpc.File___proto_tag_tag_proto.Services().ByName("TagService")
	tagServiceGetTagByIdMethodDescriptor  = tagServiceServiceDescriptor.Methods().ByName("GetTagById")
	tagServiceGetAllTagsMethodDescriptor  = tagServiceServiceDescriptor.Methods().ByName("GetAllTags")
	tagServiceGetNextTagsMethodDescriptor = tagServiceServiceDescriptor.Methods().ByName("GetNextTags")
	tagServiceGetPrevTagsMethodDescriptor = tagServiceServiceDescriptor.Methods().ByName("GetPrevTags")
)
